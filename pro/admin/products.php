        ...
        <form id="add-product-form" enctype="multipart/form-data">
            ...
            <div class="col-12">
              <div class="form-group">
                ...
                <input type="number" name="product_qty" class="form-control" placeholder="Introduza a quantidade de produto">
              </div>
            </div>
        		<div class="col-12">
        			<div class="form-group">
		        		<label>Preço Produto</label>
		        		<input type="number" name="product_price" class="form-control" placeholder="Introduza o preço de produto">
		        	</div>
        		</div>
        		<div class="col-12">
        			<div class="form-group">
        ...
        <form id="edit-product-form" enctype="multipart/form-data">
          <div class="row">
            <div class="col-12">
              <div class="form-group">
                <label>Nome Produto</label>
                <input type="text" name="e_product_name" class="form-control" placeholder="Introduza o nome do produto">
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
            ...
            <div class="col-12">
              <div class="form-group">
                <label>Descrição Produto</label>
                <textarea class="form-control" name="e_product_desc" placeholder="Introduza a descrição do produto"></textarea>
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
                <label>Quantidade Produto</label>
                <input type="number" name="e_product_qty" class="form-control" placeholder="Introduza a quantidade de produto">
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
                <label>Preço Produto</label>
                <input type="number" name="e_product_price" class="form-control" placeholder="Introduza o preço de produto">
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
                <label>Palavras-chave do produto <small>(ex: maçã, iphone)</small></label>
                <input type="text" name="e_product_keywords" class="form-control" placeholder="Introduza as palavras-chave do produto">
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
            ...
            <div class="col-12">
              <button type="button" class="btn btn-primary submit-edit-product">Adicionar Produto</button>
            </div>
          </div>
