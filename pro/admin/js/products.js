$(document).ready(function(){
		...
		$.ajax({
			...
			success : function(response){
				...
				if (resp.status == 202) {
					...
					var catSelectHTML = '<option value="">Seleccione a Categoria</option>';
					...
					var brandSelectHTML = '<option value="">Seleccione a Marca</option>';
	...
	$(document.body).on('click', '.delete-product', function(){
		...
		if (confirm("Você tem certeza de excluir este item ?")) {
			$.ajax({
