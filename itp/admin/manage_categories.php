...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header"><strong>Formulário Categorias</strong> </div>
                        <form method="post">
							<div class="card-body card-block">
							   <div class="form-group">
									<label for="categories" class=" form-control-label">Categorias</label>
									<input type="text" name="categories" placeholder="Introduza o nome da Categoria" class="form-control" required value="<?php echo $categories?>">
								</div>
