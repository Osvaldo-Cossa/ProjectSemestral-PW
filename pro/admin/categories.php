        	...
        	<div class="row">
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<input type="text" name="cat_title" class="form-control" placeholder="Introduza o nome da categoria">
		        	</div>
        		</div>
        ...
        <form id="edit-category-form" enctype="multipart/form-data">
          <div class="row">
            <div class="col-12">
              ...
              <div class="form-group">
                <label>Nome da Categoria</label>
                <input type="text" name="e_cat_title" class="form-control" placeholder="Introduza o nome da categoria">
              </div>
            </div>
            <input type="hidden" name="edit_category" value="1">
            <div class="col-12">
              <button type="button" class="btn btn-primary edit-category-btn">Actualizar a Categoria</button>
            </div>
          </div>
